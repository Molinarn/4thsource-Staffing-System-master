...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength) {
            ...
            var input = $('<input type="text" style="width:60px;height:15px;font-size:0.9em" class="' + search_init + sCSSClass + '" value="' + inputvalue + '"/>');
            th.html(input);
            if (bIsNumber)
        ...
        function fnCreateRangeInput(oTable) {
            ...
            var from = $('<input type="text" style="width:55px;height:15px;font-size:0.9em" onkeypress="ValidaSoloNumeros()" class="number_range_filterc" id="' + sFromId + '" rel="' + i + '"/>');
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" style="width:55px;height:15px;font-size:0.9em" onkeypress="ValidaSoloNumeros()" class="number_range_filter" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
        ...
        function fnCreateDateRangeInput(oTable) {
            th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" style="width:55px;height:15px;font-size:0.9em" class="date_range_filter" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker();
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" style="width:55px;height:15px;font-size:0.9em" class="date_range_filter" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
            th.append(_fnRangeLabelPart(2));
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel) {
            ...
            var r = '<select class="search_init select_filter" style="width:125px;height:24px;font-size:0.9em"><option value="" class="search_init">' + sLabel + '</option>';
            var j = 0;
