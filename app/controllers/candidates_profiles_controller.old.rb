...
class CandidatesProfilesController < ApplicationController
  ...
  def index 
    ...
    @candidates_profiles = @candidate.candidates_profiles.paginate(:page => params[:page], :per_page => 20)
  ...
  def show
    @candidates_profile = CandidatesProfiles.find_by_id(params[:candidates_profile_id])
  ...
  # GET /candidates_profiles/1.json
  def editprofile
    @candidates_profile = CandidatesProfile.find_by_id(params[:candidate_profile_id])
    @candidate = Candidate.find_by_id(@candidates_profile.candidate_id)  
    render :edit 
  end
  ...
  def delete
    @candidates_profile = CandidatesProfile.find(params[:candidate_profile_id])
  ...
  def createjob
    ...
    candidateProfileId = params[:candidate_profile_id];
