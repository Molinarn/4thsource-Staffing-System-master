...
#  match "/education/destroy" => 'educations#destroy'
  ...
  match "/candidates/:id/education_degree" => 'educ_degrees#index'
  match "/candidates/:id/education_degree/new" => 'educ_degrees#new'
  match "/candidates/:id/education_degree/create" => 'educ_degrees#create'
  match "/candidates/:id/education_degree/edit" => 'educ_degrees#edit'
  match "/candidates/:id/education_degree/update" => 'educ_degrees#update'
  match "/candidates/:id/education_degree/destroy" => 'educ_degrees#destroy'
  match "/candidates/:id/education_degree/action" => 'educ_degrees#action'
