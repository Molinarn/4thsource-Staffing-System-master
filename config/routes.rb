...
#  match "/education/destroy" => 'educations#destroy'
  ...
  match "/candidates/:id/education_degrees" => 'educ_degrees#index'
  match "/candidates/:id/education_degrees/new" => 'educ_degrees#new'
  match "/candidates/:id/education_degrees/create" => 'educ_degrees#create'
  match "/candidates/:id/education_degrees/edit" => 'educ_degrees#edit'
  match "/candidates/:id/education_degrees/update" => 'educ_degrees#update'
  match "/candidates/:id/education_degrees/destroy" => 'educ_degrees#destroy'
  match "/candidates/:id/education_degrees/action" => 'educ_degrees#action'
  ...
  #Added
  match "/candidates/:candidate_id/candidates_profiles/new" => 'candidates_profiles#new'
  ...
  match "/staff/:id/newcandidate" => 'staff_candidates#newcandidate'
